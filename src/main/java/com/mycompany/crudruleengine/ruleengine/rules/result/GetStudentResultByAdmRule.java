 ...
 */
@ApplicationScoped
public class GetStudentResultByAdmRule implements ServiceRule {
    ...
    public boolean matches(Object input) {
        return (input.toString().equalsIgnoreCase(RequestTypes.GET_RESULT_BY_ADMISSION.name()));
    ...
    public JSONObject apply(Object input) {
        ...
        ServiceResponder response=resultsService.getStudentResultsByAdm(request);
